...
public class BookingInfoController {
	...
	@GetMapping(value = "/bookinginfo/tours-id/{id}") // S=>5
	public List<BookingInfo> getAllBookingInfoByToursId(@PathVariable Long id) {
		return bookingInfoServicce.getAllBookingInfoByToursId(id);
	}

	@GetMapping(value = "/bookinginfo/package-id/{id}") // S=>5
	public List<BookingInfo> getAllBookingInfoByPackageId(@PathVariable Long id) {
		return bookingInfoServicce.getAllBookingInfoByPackageId(id);
	}

	@GetMapping(value = "/bookinginfo/hotel-id/{id}") // S=>5
	public List<BookingInfo> getAllBookingInfoByHotelId(@PathVariable Long id) {
		return bookingInfoServicce.getAllBookingInfoByHotelId(id);
	}
